...
class QuickCreateUIConfig(BaseModel):
    ...
    author_enabled: bool = Field(default=False, description="Show the author below the title on the first frame")
    author: str = Field(default="", description="Author displayed below the title on the first frame")
