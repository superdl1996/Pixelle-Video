...
class StandardPipeline(LinearVideoPipeline):
    ...
    async def plan_visuals(self, ctx: PipelineContext):
        ...
        if template_requires_media:
            ...
            image_prompt_rewrite_enabled = bool(ctx.params.get("image_prompt_rewrite_enabled", False))
            image_prompt_rewrite_prompt = ctx.params.get("image_prompt_rewrite_prompt") or ""
            ...
            try:
                ...
                base_image_prompts = await generate_image_prompts(
                    ...
                    prompt_template=(
                        ...
                        if image_prompt_rewrite_enabled and image_prompt_rewrite_prompt.strip()
                        else None
                    ),
                )
